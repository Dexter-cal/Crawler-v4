...
class LLMAnalyzer:
    ...
    def run(self, args: dict):
        ...
        prompt = f"Analyze the following text for suspicious content: {text_to_analyze}"
        payload = {"model": "some-llm-model-name", "messages": [{"role": "user", "content": prompt}], "response_format": {"type": "json_object"}}
